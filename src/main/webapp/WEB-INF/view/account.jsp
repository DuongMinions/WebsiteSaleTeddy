...
<div class="container">
    <div class="frame">
        ...
        <div ng-app ng-init="checked = false">
            <form class="form-signin" action="/mon-gau-bong/login" method="post" name="form">
                <label>Email</label>
                <input class="form-styling" type="text" name="username" placeholder="Email or Phone"/>
                <p>${validate}</p>
